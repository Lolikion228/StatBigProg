...
### v2
Также, можно задать параметр $\lambda_1$ и получить выборку из $\text{Pois}(\lambda_1)$ после этого 
...
### P.S.
Вроде бы, для того чтобы запустить это достаточно иметь QtCreator и скормить ему директорию в которой лежит файл .pro
