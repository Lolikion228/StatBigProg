 ...
 * с помощью инверсного метода (`PoisGen1`) и вычисляются частоты вместе со значением p-value.
 *
 ...
 *
 * ## 3. Управление кэшем распределения и генератор Кнута (PoisGen2)
 ...
 * - **Метод обратной функции** (реализован в классе PoisGen1) —
 * моделирование через последовательное суммирование вероятностей и сравнение с CDF.
 * - **Алгоритм Кнута** (реализован в классе PoisGen2) — моделирование на основе
